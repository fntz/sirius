...
typeof a+" given");}return[]};b.prototype._compute=function(a,b){var d=this;return this.constructor.prototype._cmp.forEach(function(f){if(-1!==f.get_fields().indexOf(a)){var e=f.complete(a,b);if(f.is_full())return d._set(f.field_name(),e)}})};b.prototype.normalize_attrs=function(){var a;var b=this.attrs();var f=[];var e=0;for(a=b.length;e<a;e++){var g=b[e];f.push(function(a){return Sirius.Utils.is_object(a)?Object.keys(a)[0]:a}(g))}return f};b.prototype._gen_method_name_for_attribute=function(a){var b=
...
null!==a)throw Error("Attribute '"+a+"' not found for "+this._klass_name()+" model");if(null!=a){var f=[];a=this.errors[a];for(b in a){var e=a[b];""!==e&&f.push(e)}return f}return this.errors};b.prototype.set_error=function(a,b){var d=a.split(".");if(2!==d.length)throw Error("Error must be pass as 'attr.validator' like 'name.length'");this.errors[d[0]][d[1]]=b;return this._is_valid_attr[d[0]]=!1};b.prototype.save=function(){this.validate();return this.is_valid()?!1:!0};b.prototype.to_json=function(){var a=
1<=arguments.length?slice.call(arguments,0):[];return JSON.stringify(this.to_object.apply(this,a))};b.prototype.to_object=function(){var a;var b=1<=arguments.length?slice.call(arguments,0):[];var f={};var e=this.attributes;var g=0;for(a=e.length;g<a;g++){var h=e[g];if(-1===b.indexOf(h)){var k=this.get(h);f[h]=k}}return f};b.from_json=function(a){var b;var f=new this;a=JSON.parse(a);var e=[].concat(f.attrs());var g=0;for(b=e.length;g<b;g++){var h=e[g];if("object"===typeof h){var k=Object.keys(h);k=
k[0];f.set(k,a[k]||h[k])}else k=a[h],f.set(h,k||f.get(h))}return f};b.prototype.compare=function(a){throw Error("`compare` method must be overridden");};b.prototype.after_create=function(){};b.prototype.after_update=function(a,b,f){};b.prototype.clone=function(){return this.constructor.from_json(this.to_json())};b.prototype._register_state_listener=function(a){var b;this.logger.debug("Register new listener for "+this.constructor.name,this.logger.base_model);this._listeners.push(a);var f=this.get_attributes();
var e=[];var g=0;for(b=f.length;g<b;g++){var h=f[g];null!==this["_"+h]?e.push(a.apply(null,[h,this["_"+h]])):e.push(void 0)}return e};b.prototype.pipe=function(a,b){null==b&&(b={});(new Sirius.Transformer(this,a)).run(b)};b.prototype.bind=function(a,b){null==b&&(b={});return this.pipe(a,b)};b.define_model=function(a){var b;var f=["attrs","guid_for","validate"];var e=function(b){function d(){return d.__super__.constructor.apply(this,arguments)}extend(d,b);d.attrs=a.attrs||[];d.guid_for=a.guid_for||
null;d.validate=a.validate||{};return d}(Sirius.BaseModel);for(b in a){var g=a[b];-1===f.indexOf(b)&&(e.prototype[b]=g)}return e};b.register_validator=function(a,b){var d=Sirius.Application.get_logger();d.info("register validator: "+a,d.base_model);this._Validators.push([a,b]);return null};return b}();Sirius.BaseModel.register_validator("length",Sirius.LengthValidator);Sirius.BaseModel.register_validator("exclusion",Sirius.ExclusionValidator);Sirius.BaseModel.register_validator("inclusion",Sirius.InclusionValidator);
Sirius.BaseModel.register_validator("format",Sirius.FormatValidator);Sirius.BaseModel.register_validator("numericality",Sirius.NumericalityValidator);Sirius.BaseModel.register_validator("presence",Sirius.PresenceValidator);Sirius.Internal.AbstractTransformer=function(){function b(a,b,f){this._path=a;this._from=b;this._to=f;this.logger=Sirius.Application.get_logger();this._ln=this.logger.transformer;this._register()}b.prototype._register=function(){};return b}();
