...
{old:this.use_hash_routing_for_old_browsers,support:this.push_state_support,ignore:this.ignore_not_matched_urls},function(a){return function(){var c;var b=a._wait;var d=0;for(c=b.length;d<c;d++){var e=b[d];e.set_value(a.adapter)}a.adapter.fire(document,"application:run",new Date);b=a._messages_queue;var f=[];e=0;for(d=b.length;e<d;e++)c=b[e],f.push(a.logger[c[0]].call(null,c[1],c[2]));return f}}(this));if(this.start)return Sirius.redirect(this.start)}};
...
null!==a)throw Error("Attribute '"+a+"' not found for "+this._klass_name()+" model");if(null!=a){var e=[];a=this.errors[a];for(b in a){var d=a[b];""!==d&&e.push(d)}return e}return this.errors};b.prototype.set_error=function(a,b){var c=a.split(".");if(2!==c.length)throw Error("Error must be pass as 'attr.validator' like 'name.length'");var d=c[0];c=c[1];this.errors[d][c]=b;this._is_valid_attr[d]=!1;return this._call_callbacks_for_errors(d,c,b)};b.prototype.save=function(){this.validate();return this.is_valid()?
!1:!0};b.prototype.to_json=function(){var a=1<=arguments.length?slice.call(arguments,0):[];return JSON.stringify(this.to_object.apply(this,a))};b.prototype.to_object=function(){var a;var b=1<=arguments.length?slice.call(arguments,0):[];var e={};var d=this.attributes;var f=0;for(a=d.length;f<a;f++){var g=d[f];if(-1===b.indexOf(g)){var h=this.get(g);e[g]=h}}return e};b.from_json=function(a){var b;var e=new this;a=JSON.parse(a);var d=[].concat(e.attrs());var f=0;for(b=d.length;f<b;f++){var g=d[f];if("object"===
typeof g){var h=Object.keys(g);h=h[0];e.set(h,a[h]||g[h])}else h=a[g],e.set(g,h||e.get(g))}return e};b.prototype.compare=function(a){throw Error("`compare` method must be overridden");};b.prototype.after_create=function(){};b.prototype.after_update=function(a,b,e){};b.prototype.clone=function(){return this.constructor.from_json(this.to_json())};b.prototype._register_state_listener=function(a){var b;this.logger.debug("Register new listener for "+this.constructor.name,this.logger.base_model);this._listeners.push(a);
var e=this.get_attributes();var d=[];var f=0;for(b=e.length;f<b;f++){var g=e[f];null!==this["_"+g]?d.push(a.apply(null,[g,this["_"+g]])):d.push(void 0)}return d};b.prototype.pipe=function(a,b){null==b&&(b={});(new Sirius.Transformer(this,a)).run(b)};b.prototype.bind=function(a,b){null==b&&(b={});return this.pipe(a,b)};b.register_validator=function(a,b){var c=Sirius.Application.get_logger();c.info("register validator: "+a,c.base_model);this._Validators.push([a,b]);return null};return b}();
