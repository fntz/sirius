...
lib$sirius$classdecl$var1.prototype.bind=function(a,b,c,d){var e,f;if(null===b||b===a)a.addEventListener(c,d);else if("object"===typeof b&&1===b.nodeType)b.addEventListener(c,d);else for(a=this.all(b),b=e=0,f=a.length;0<=f?e<f:e>f;b=0<=f?++e:--e)a.item(b).addEventListener(c,d)};lib$sirius$classdecl$var1.prototype.off=function(a,b,c,d){var e,f;if(null===b||b===a)a.removeEventListener(c,d);else for(a=this.all(b),b=e=0,f=a.length;0<=f?e<f:e>f;b=0<=f?++e:--e)a.item(b).removeEventListener(c,d)};
lib$sirius$classdecl$var1.prototype.fire=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];e=document.createEvent("CustomEvent");e.initCustomEvent(b,!1,!0,d);document.dispatchEvent(e)};lib$sirius$classdecl$var1.prototype.get_property=function(a,b){var c;a=a.target;var d=[];var e=0;for(c=b.length;e<c;e++){var f=b[e];d.push(this.get_attr(a,f))}return d};
lib$sirius$classdecl$var1.prototype.get_attr=function(a,b){a=this._get_element_from_selector(a);var c=a.getAttribute(b);return null==c?a[b]:c};lib$sirius$classdecl$var1.prototype.swap=function(a,b){a=this._get_element_from_selector(a);var c=a.tagName;"INPUT"===c||"TEXTAREA"===c||"SELECT"===c?a.value=b:a.textContent=b};lib$sirius$classdecl$var1.prototype.set_attr=function(a,b,c){this._get_element_from_selector(a).setAttribute(b,c)};
lib$sirius$classdecl$var1.prototype.set_prop=function(a,b,c){this._get_element_from_selector(a).setAttribute(b,c)};lib$sirius$classdecl$var1.prototype.append=function(a,b){a=this._get_element_from_selector(a);a.textContent+=b};lib$sirius$classdecl$var1.prototype.prepend=function(a,b){a=this._get_element_from_selector(a);a.textContent=b+a.textContent};
...
Sirius.Logger=function(){var a=function(a,b,e,f){var c=this,d;var k=Sirius.Logger.Filters;var m=0;for(d=k.length;m<d;m++){var q=k[m];this[Sirius.Utils.underscore(q).toLowerCase()]=q}var p=Sirius.Logger.Levels;d=0;for(q=p.length;d<q;d++)m=p[d],function(d){return c[d.get_value()]=function(c,g){if(a&&d.gte(b)){if(!g)return f(d.toUpperCase(),c);if(-1!==e.indexOf(g)||null==g||-1===k.indexOf(g))return c="["+g.toUpperCase()+"] "+c,f(d.toUpperCase(),c)}}}(m)};a.is_valid_level=function(a){return 0!==Sirius.Logger.Levels.filter(function(b){return b.get_value()===
a}).length};var b=function(a,b){this.value=a;this.weight=b};b.prototype.gte=function(a){return a>=this.weight};b.prototype.get_value=function(){return this.value};a.Debug=new b("debug",10);a.Info=new b("info",20);a.Warn=new b("warn",30);a.Error=new b("error",40);a.Levels=[a.Debug,a.Info,a.Warn,a.Error];a.Filters="BaseModel Binding Collection View Routing Application Redirect Validation Transformer".split(" ");return a}.call(this);Sirius.Internal={};
...
var lib$sirius$classdecl$var6=function(a,b){b=void 0===b?function(a){return a}:b;this.logger=Sirius.Application.get_logger();var c;if(!(c=a.controller))throw Error("Params must contain a Controller");var d=a.action;if(Sirius.Utils.is_string(d))var e=c[d];else if(Sirius.Utils.is_function(d))e=d;else throw b="Action must be string or function",this.logger.error("ControlFlow: "+b,this.logger.routing),Error(b);if(!e)throw b="action "+d+" not found in controller "+c,this.logger.error("ControlFlow: "+b,
this.logger.routing),Error(b);this.action=b(e);b=function(b,e){e=void 0===e?!1:e;var f=a[b];var g=c[b+"_"+d];var m=function(a){return Error(a+" action must be string or function")};if(Sirius.Utils.is_string(f)){e=c[f];if(!Sirius.Utils.is_function(e))throw m(Sirius.Utils.camelize(b));return e}if(Sirius.Utils.is_function(f))return f;if(f)throw m(Sirius.Utils.camelize(b));if(g){if(!Sirius.Utils.is_function(g))throw m(Sirius.Utils.camelize(b));return g}return e?null:function(){}};this.before=b("before");
...
b);e.push([f,c])}return e},_get_plain_routes:function(a,b,c,d){var e=[];for(f in a)if(c=a[f],this._is_plain_route(f)){d.debug("RouteSystem: define route: '"+f+"'",d.routing);var f=new Sirius.Internal.RoutePart(f);c=Sirius.Utils.is_function(c)?b(c):new Sirius.Internal.ControlFlow(c,b);e.push([f,c])}return e},create:function(a,b,c){var d=this;c=void 0===c?function(){}:c;var e;var f=Sirius.Application.get_logger();var g=e=window.location.hash;var h=b.old;var k=b.support;var m=b.ignore;return Sirius.Application.get_adapter().and_then(function(b){if(h&&
!k){f.info("RouteSystem: Convert plain routing into hash routing",f.routing);var p=[];var q={};for(n in a){var r=a[n];d._is_hash_route(n)&&p.push(n);if(d._is_plain_route(n)){var n="#"+n;-1!==p.indexOf(n)&&f.warn("RouteSystem: Routes already defined '"+n+"' url",f.routing)}q[n]=r}a=q}var t=function(a){var b;var c=Sirius.Application.controller_wrapper;for(b in c){var d=c[b];this[b]=d}return a};d._event_register(a,t,b,f);d._scheduler_register(a,t,b,f);var v=d._get_hash_routes(a,t,b,f);var w=d._get_plain_routes(a,
t,b,f);var x=function(a){return a.preventDefault?a.preventDefault():a.returnValue=!1};var u=function(c){var d,h,q;e=g;var p=q=!1;f.info("RouteSystem: start processing route: '"+g+"'",f.routing);if("hashchange"===c.type){var n=v;g=window.location.hash;var l=window.location.origin;p=!0;k?history.pushState({href:g},""+g,l+"/"+g):history.replaceState({href:g},""+g,l+"/"+g)}else n=w,l=c.target.href,"popstate"!==c.type&&k&&history.pushState({href:l},""+l,l),l=window.location.pathname,""===l&&(l="/"),g=
l;var r=0;for(d=n.length;r<d;r++){var u=n[r];l=u[0];(h=l.match(g))&&!q&&(q=!0,u=u[1],u.handle_event?u.handle_event(null,l.args):u.apply(null,l.args))}q?(x(c),f.debug("RouteSystem: Url change to: "+g,f.routing),b.fire(document,"application:urlchange",g,e)):m?(p&&f.warn("Seems you ignore hash based urls: "+g),f.debug("ignore_not_matched_urls is enabled, url was not matched: '"+g+"'")):(f.warn("RouteSystem: route '"+g+"' not found. Generate 404 event",f.routing),b.fire(document,"application:404",g,e),
(p=a["404"]||a[404])&&(Sirius.Utils.is_function(p)?t(p)(g):(new Sirius.Internal.ControlFlow(p,t)).handle_event(null,g)),x(c))};d.dispatch=u;0!==w.length&&b.bind(document,d._selector,"click",u);window.onhashchange=u;k&&b.bind(window,null,"popstate",function(a){if(history&&null!=history.state&&void 0!==history.state.href&&0!==history.state.href.indexOf("#"))return u(a)});return c()})}};
Sirius.Application={log:!1,enable_logging:!1,adapter:null,running:!1,route:{},start:!1,controller_wrapper:{redirect:Sirius.redirect},mix_logger_into_controller:!0,use_hash_routing_for_old_browsers:!0,ignore_not_matched_urls:!0,default_log_function:function(a,b){return console&&console.log?console.log(a+": "+b):alert("Not supported `console`. You should define own `logger` function for Sirius.Application")},log_filters:[],minimum_log_level:Sirius.Logger.Debug.get_value(),_wait:[],_messages_queue:[],
get_logger:function(){var a;if(this.logger)return this.logger;var b=Sirius.Logger.Levels;var c={};var d=this._messages_queue;var e=0;for(a=b.length;e<a;e++){var f=b[e];(function(a){return c[a.get_value()]=function(b,c){return d.push([a,b,c])}})(f)}b=Sirius.Logger.Filters;f=0;for(a=b.length;f<a;f++)e=b[f],c[Sirius.Utils.underscore(e).toLowerCase()]=e;return c},get_adapter:function(){if(null==this.adapter){var a=new Sirius.Promise;this._wait.push(a);return a}return new Sirius.Promise(this.adapter)},
run:function(a){var b=this;a=void 0===a?{}:a;var c,d;var e=function(b,c){return null!=a[b]?a[b]:c};this.running=!0;this.enable_logging=a.log||a.enable_logging||this.enable_logging;this.adapter=a.adapter||new VanillaJsAdapter;this.route=a.route||this.route;this.mix_logger_into_controller=e("mix_logger_into_controller",this.mix_logger_into_controller);this.log_filters=a.log_filters||this.log_filters;this.ignore_not_matched_urls=e("ignore_not_matched_urls",this.ignore_not_matched_urls);if((d=a.minimum_log_level)&&
!Sirius.Logger.is_valid_level(d))throw e=Sirius.Logger.Levels.map(function(a){return a.get_value()}),Error("Invalid 'minimum_log_level' value: '"+d+"', available options are: "+e.join(", "));this.minimum_log_level=d||this.minimum_log_level;if("all"===this.log_filters)this.log_filters=Sirius.Logger.Filters;else if(0<this.log_filters.length){var f=Sirius.Logger.Filters;d=this.log_filters;if("number"===typeof this.log_filters[0]){var g=d.sort()[d.length-1];var h=d.sort()[0];if(0>h)throw Error("Undefined index for log filters "+
h);if(g>f.length)throw Error("Undefined index for log filters "+g);this.log_filters=d.map(function(a){return f[a]})}else if(g=this.log_filters.filter(function(a){return-1===f.indexOf(a)}),0!==g.length)throw Error("Check log filters given `"+d+"`. Allow "+f);}else this.log_filters=[];this.logger=new Sirius.Logger(this.enable_logging,this.log_filters,this.minimum_log_level,a.logger||this.default_log_function);this.start=a.start||this.start;d=a.controller_wrapper||{};for(c in d)g=d[c],this.controller_wrapper[c]=
g;this.hash_always_on_top=e("hash_always_on_top",this.hash_always_on_top);this.use_hash_routing_for_old_browsers=e("use_hash_routing_for_old_browsers",this.use_hash_routing_for_old_browsers);this.logger.info("Logger enabled? "+this.enable_logging,this.logger.application);this.logger.info("Log filters: "+this.log_filters,this.logger.application);this.logger.info("Minimum log level: "+this.minimum_log_level,this.logger.application);this.logger.info("Adapter: "+this.adapter.name,this.logger.application);
...
this.from_element;var m=this.original;var q=null;var p=this.watch_for;var l=a.get_attr(k,"tagName");var r=a.get_attr(k,"type");f.debug("Create binding for "+k,f.binding);var n=Sirius.Internal.Observer;var t=function(b){f.debug("Handler Function: given "+b.type+" event",f.binding);var c={text:null,attribute:null,from:k,original:m,element:b.target};if(!n.is_focus_event(b)){var d=a.text(k);if(-1===[n.Ev.input,n.Ev.selectionchange].indexOf(b.type)||d!==q){n.is_text_event(b)&&(q=c.text=d);b.type===n.Ev.change&&
(c.state=a.get_state(k));if("attributes"===b.type){d=b.attributeName;var e=b.oldValue||[];var g=a.get_attr(k,d);c.text=g;c.attribute=d;c.previous=e}b.type===n.Ev.DOMAttrModified&&(d=b.originalEvent.attrName,e=b.originalEvent.prevValue,g=a.get_attr(k,d),c.text=g,c.attribute=d,c.previous=e);return h(c)}}};if("text"===p)if(-1!==c.indexOf(l)){f.debug("It is not a "+c,f.binding);if(-1!==d.indexOf(r)||l===e)return f.debug("Get a "+r+" & "+l+" element for bool elements",f.binding),a.bind(document,k,n.Ev.change,
t),Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,p,n.Ev.change,t);q=a.text(k);a.bind(document,k,n.Ev.input,t);Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,p,n.Ev.input,t);if(Sirius.Utils.is_ie9())return f.warn("Hook for work with IE9 browser",f.binding),a.bind(document,k,n.Ev.selectionchange,t),Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,p,n.Ev.selectionchange,t)}else return f.warn("Seems you try to bind for "+l+" of "+r+" for 'text' which is not supported");
else{if(b){f.debug("MutationObserver support",f.binding);var v=new b(function(a){return a.forEach(t)});l={childList:!0,attributes:!0,characterData:!0,attributeOldValue:!0,characterDataOldValue:!0,subtree:!1};r=a.get(k);v.observe(r,l);return Sirius.Internal.CacheObserverHandlers.add_new_observer(k,p,t,v,l)}f.warn("MutationObserver not supported",f.binding);f.warn("Use Deprecated events for observe",f.binding);a.bind(document,k,n.Ev.DOMNodeInserted,t);a.bind(document,k,n.Ev.DOMAttrModified,t);Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,
p,n.Ev.DOMNodeInserted,t);return Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,p,n.Ev.DOMAttrModified,t)}};var b=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver||null;var c=["INPUT","TEXTAREA","SELECT"];var d=["checkbox","radio"];var e="OPTION";a.Ev={input:"input",selectionchange:"selectionchange",childList:"childList",change:"change",DOMNodeInserted:"DOMNodeInserted",focusout:"focusout",focusin:"focusin",DOMAttrModified:"DOMAttrModified"};a.TextEvents=
...
this.logger.debug("Create a new View for "+this.element,this.logger.view);var k=this.constructor._Strategies;a=0;for(b=k.length;a<b;a++){var m=k[a];(function(a){var b=a[0];c.logger.debug("Define "+b+" strategy",c.logger.view);var e=a[1];var f=a[2];return c[b]=function(a){a=void 0===a?"text":a;var b=c._result;d=c.element;c.logger.debug("Start processing strategy for "+d,c.logger.view);return Sirius.Application.get_adapter().and_then(function(c){var g="text"===a?c.text(d):c.get_attr(d,a);g=e(g,b);return f(c,
d,g,a)})}})(m)}Sirius.View._Cache.push(this);return this};a.prototype.name=function(){return"View"};a.prototype.get_element=function(){return this.element};a.prototype._register_state_listener=function(a){this.logger.debug("Register new listener for element: "+this.get_element,this.logger.view);return this._listeners.push(a)};a.prototype.render=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];this.logger.debug("Call render for "+b,this.logger.view);this._result=this._result_fn(b);
return this};a.prototype.zoom=function(a){a=a===this.element?this:new Sirius.View(this.element+" "+a);a._result=this._result;return a};a.prototype.on=function(a,b,f,g){for(var d=[],e=3;e<arguments.length;++e)d[e-3]=arguments[e];a=a===this.element?a:this.element+" "+a;if(Sirius.Utils.is_string(f))var m=0;else if(Sirius.Utils.is_function(f))m=1;else throw Error("View: 'custom_event_name' must be string or function, "+typeof f+" given");var q=new c(a,b,f);e=this._cache_event_handlers.filter(function(a){return a.eq(q)});
if(0===e.length)if(this.logger.info("Bind event for "+a+", event name: "+b+", will be called : "+f,this.logger.view),0===m){var p=function(a){return Sirius.Application.get_adapter().and_then(function(b){return b.fire.call.apply(b.fire,[null,document,f,a].concat($jscomp.arrayFromIterable(d)))})};Sirius.Application.get_adapter().and_then(function(c){return c.bind(document,a,b,p)});e=new c(a,b,p);this._cache_event_handlers.push(e)}else Sirius.Application.get_adapter().and_then(function(c){return c.bind(document,
a,b,f)}),this._cache_event_handlers.push(q);else{var l=e.shift();e=this._cache_event_handlers.indexOf(l);-1<e&&this._cache_event_handlers.splice(e,1);this._cache_event_handlers.push(q);Sirius.Application.get_adapter().and_then(function(c){c.off(document,a,b,l.custom_event_name);l=null;return c.bind(document,a,b,f)})}};a.prototype.for_me=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];return this.on.apply(this,[this.get_element(),a,b].concat($jscomp.arrayFromIterable(d)))};
...
var m=b[0];d=b.length;f=$jscomp.makeIterator(Sirius.Utils.is_function(b[d-1])?(k=b[d-1],[b.slice(1,d-1),b.slice(1,d-1),k]):[b.slice(1),b.slice(1),null]);b=f.next().value;d=f.next().value;k=f.next().value;f=[m].concat(b);if(f.filter(function(a,b,c){return c.indexOf(a)===b}).length!==f.length)throw Error("Seems your calculated fields are not unique: ["+f+"]");var q=this.attrs.concat(this.prototype._cmp_fields);b.forEach(function(a){if(-1===q.indexOf(a))throw Error("Field is '"+a+"' not found, for '"+
m+"'");});if(0<this.prototype._cmp_fields.length&&(f=b.filter(function(a){return e.prototype._cmp_refs[a]&&-1!==e.prototype._cmp_refs[a].indexOf(m)}),0<f.length))throw Error("Cyclic references detected in '"+m+"' field");Sirius.Application.get_logger().info("Define compute field '"+m+"' <- '["+b+"]'",Sirius.Application.get_logger().base_model);this.prototype._cmp_refs[m]=b;this.prototype._cmp_fields.push(m);return this.prototype._cmp.push(new ComputedField(m,d,k))};a.prototype.attrs=function(){return(this.constructor.attrs||
...
{})}};a.prototype.is_valid=function(){var a=this;return 0===Object.keys(this._is_valid_attr).filter(function(b){return!a._is_valid_attr[b]}).length};a.prototype.validate=function(a){var b=this;a=void 0===a?null:a;var d=this._klass_name();var e=this.logger;var f=this.logger.base_model;Object.keys(this._model_validators||{}).filter(function(b){return null!=a?b===a:!0}).map(function(a){var c,g;var m=b.get(a);var q=b._model_validators[a];var p=[];for(c in q){var l=q[c];var r="validate_with"===c?(g=new Sirius.Validator,
g.validate=l,g.msg=null,g):(g=b._registered_validators.filter(function(a){return a[0]===c})[0][1],new g);l=r.validate(m,l);e.debug("Validate: '"+d+"."+a+" = "+m+"' with '"+c+"' validator, valid?: '"+l+"'",f);r=l?(delete b.errors[a][c],b._is_valid_attr[a]=!0,""):(b.errors[a][c]=r.error_message(),b._is_valid_attr[a]=!1,r.error_message());p.push(b._call_callbacks_for_errors(a,c,r))}return p})};a.prototype.get_errors=function(a){a=void 0===a?null:a;var b;if(-1===this.attributes.indexOf(a)&&null!==a)throw Error("Attribute '"+
a+"' not found for "+this._klass_name()+" model");if(null!=a){var d=[];a=this.errors[a];for(b in a){var e=a[b];""!==e&&d.push(e)}return d}return this.errors};a.prototype.set_error=function(a,c){a=a.split(".");if(2!==a.length)throw Error("Error must be pass as 'attr.validator' like 'name.length'");var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;this.errors[a][b]=c;this._is_valid_attr[a]=!1;return this._call_callbacks_for_errors(a,b,c)};a.prototype.save=function(){this.validate();return this.is_valid()?
!1:!0};a.prototype.to_json=function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];return JSON.stringify(this.to_object.apply(this,$jscomp.arrayFromIterable(b)))};a.prototype.to_object=function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e;var f={};var g=this.attributes;var h=0;for(e=g.length;h<e;h++)if(d=g[h],-1===b.indexOf(d)){var k=this.get(d);f[d]=k}return f};a.from_json=function(a){var b;var d=new this;a=JSON.parse(a);var e=[].concat(d.attrs());var f=0;
for(b=e.length;f<b;f++){var g=e[f];if("object"===typeof g){var h=Object.keys(g);h=h[0];d.set(h,a[h]||g[h])}else h=a[g],d.set(g,h||d.get(g))}return d};a.prototype.compare=function(a){throw Error("`compare` method must be overridden");};a.prototype.after_create=function(){};a.prototype.after_update=function(a,c,d){};a.prototype.clone=function(){return this.constructor.from_json(this.to_json())};a.prototype._register_state_listener=function(a){var b;this.logger.debug("Register new listener for "+this.constructor.name,
this.logger.base_model);this._listeners.push(a);var d=this.get_attributes();var e=[];var f=0;for(b=d.length;f<b;f++){var g=d[f];null!==this["_"+g]?e.push(a.apply(null,[g,this["_"+g]])):e.push(void 0)}return e};a.prototype.pipe=function(a,c){c=void 0===c?{}:c;(new Sirius.Transformer(this,a)).run(c)};a.prototype.bind=function(a,c){c=void 0===c?{}:c;return this.pipe(a,c)};a.register_validator=function(a,c){var b=Sirius.Application.get_logger();b.info("register validator: "+a,b.base_model);this._Validators.push([a,
c]);return null};a._Validators=[];a.attrs=[];a.skip=!1;a.guid_for=null;a.validate={};a.prototype.__name="BaseModel";return a}.call(this);Sirius.BaseModel.register_validator("length",Sirius.LengthValidator);Sirius.BaseModel.register_validator("exclusion",Sirius.ExclusionValidator);Sirius.BaseModel.register_validator("inclusion",Sirius.InclusionValidator);Sirius.BaseModel.register_validator("format",Sirius.FormatValidator);Sirius.BaseModel.register_validator("numericality",Sirius.NumericalityValidator);
Sirius.BaseModel.register_validator("presence",Sirius.PresenceValidator);var lib$sirius$classdecl$var17=function(a,b,c){this._path=a;this._from=b;this._to=c;this.logger=Sirius.Application.get_logger();this._ln=this.logger.transformer;this._register()};lib$sirius$classdecl$var17.prototype._register=function(){};Sirius.Internal.AbstractTransformer=lib$sirius$classdecl$var17;var lib$sirius$classdecl$var18=function(){Sirius.Internal.AbstractTransformer.apply(this,arguments)};
$jscomp.inherits(lib$sirius$classdecl$var18,Sirius.Internal.AbstractTransformer);lib$sirius$classdecl$var18.prototype._register=function(){var a;if(this._from instanceof Sirius.BaseModel)return this._from._register_state_listener(this._to);this._from._register_state_listener(this);var b=this._fire_generator();var c=this._from.get_element();var d=this._path;var e=[];for(a in d)d=this._path.from||"text",e.push(new Sirius.Internal.Observer(c+" "+a,a,d,b));return e};
...
this._ln);e.push(new Sirius.Internal.Observer(c,k,g,b))}return e}return this._from._register_state_listener(b)};lib$sirius$classdecl$var19._default_via_method=function(){return function(a,b,c,d){d=void 0===d?"text":d;return c.zoom(b).render(a).swap(d)}};
lib$sirius$classdecl$var19.prototype._fire_generator=function(){var a=this._to;var b=this._path;var c=this.logger;var d=this._ln;if(this._from instanceof Sirius.View)var e=function(c){var d;var e=b.to;var f=c.text;var g=[];var p=0;for(d=e.length;p<d;p++){var l=e[p];if(Sirius.Utils.is_string(l)){var r=Sirius.Internal.ToViewTransformer._default_via_method();g.push(r(f,l,a,attribute))}else{var n=l.selector;c=l.attribute||"text";r=l.via||Sirius.Internal.ToViewTransformer._default_via_method();g.push(r(f,
n,a,c))}}return g};else{var f=this._from;e=function(e,h){var g;if(g=b[e]){c.debug("Apply new value for '"+e+"' for '"+a.get_element()+"', value: "+h+" from "+f._klass_name(),d);var m=g.to;e=g.attr||"text";g=g.via||Sirius.Internal.ToViewTransformer._default_via_method();return g(h,m,a,e)}}}return e};Sirius.Internal.ToViewTransformer=lib$sirius$classdecl$var19;var lib$sirius$classdecl$var20=function(){Sirius.Internal.AbstractTransformer.apply(this,arguments)};
$jscomp.inherits(lib$sirius$classdecl$var20,Sirius.Internal.AbstractTransformer);lib$sirius$classdecl$var20.prototype._register=function(){var a;this._from._register_state_listener(this);var b=this._fire_generator();var c=this._from.get_element();var d=this._path;var e=[];for(a in d)d=this._path.from||"text",e.push(new Sirius.Internal.Observer(c+" "+a,a,d,b));return e};lib$sirius$classdecl$var20.prototype._default_via_method=function(){return function(a){return a}};
