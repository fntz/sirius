...
Sirius.Logger=function(){var a=function(a){var b=this;this.log_source=a;this._log_queue=[];if(!Sirius.Logger.Configuration._is_initialized){var c=setInterval(function(){return f()},100);var f=function(){var a;if(Sirius.Logger.Configuration._is_initialized){var d=b._log_queue;var e=0;for(a=d.length;e<a;e++){var f=d[e];b._write(f.level,f.message)}return clearInterval(c)}}}};a.build=function(a){return new Sirius.Logger(a)};a.prototype.debug=function(a){return this._write(Sirius.Logger.Debug,a)};a.prototype.info=
...
else if(d(h)){h=new RegExp("^"+h+"$");if(!h.test(g))return!1;a.push(h.exec(g)[0])}else{if(e(h)){a=a.concat(b.slice(f));break}if(h!==g)return!1}}this.args=a;return!0};Sirius.Internal.RoutePart=lib$sirius$classdecl$var5;
...
1]=arguments[f];return(new Sirius.Internal.ControlFlow(e,b)).handle_event(a,d)};var g=a.match(/^([a-zA-Z:]+)(\s+)?(.*)?/);a=g[1];g=g[3]||document;c.bind(document,g,a,f);return d.debug("RouteSystem: define event route: '"+a+"' for '"+c.as_string(g)+"'",d.routing)}(e,g))}return f},_get_hash_routes:function(a,b,c,d){var e=[];for(f in a)if(c=a[f],this._is_hash_route(f)){d.info("RouteSystem: define hash route: '"+f+"'",d.routing);var f=new Sirius.Internal.RoutePart(f);c=Sirius.Utils.is_function(c)?b(c):
new Sirius.Internal.ControlFlow(c,b);e.push([f,c])}return e},_get_plain_routes:function(a,b,c,d){var e=[];for(f in a)if(c=a[f],this._is_plain_route(f)){d.debug("RouteSystem: define route: '"+f+"'",d.routing);var f=new Sirius.Internal.RoutePart(f);c=Sirius.Utils.is_function(c)?b(c):new Sirius.Internal.ControlFlow(c,b);e.push([f,c])}return e},create:function(a,b,c){var d=this;c=void 0===c?function(){}:c;var e;var f=Sirius.Application.get_logger(this.constructor.name);var g=e=window.location.hash;var h=
b.old;var k=b.support;var l=b.ignore;return Sirius.Application.get_adapter().and_then(function(b){if(h&&!k){f.info("RouteSystem: Convert plain routing into hash routing");var n=[];var q={};for(m in a){var p=a[m];d._is_hash_route(m)&&n.push(m);if(d._is_plain_route(m)){var m="#"+m;-1!==n.indexOf(m)&&f.warn("RouteSystem: Routes already defined '"+m+"' url")}q[m]=p}a=q}var u=function(a){var b;var c=Sirius.Application.controller_wrapper;for(b in c){var d=c[b];this[b]=d}return a};d._event_register(a,u,
b,f);d._scheduler_register(a,u,b,f);var x=d._get_hash_routes(a,u,b,f);var v=d._get_plain_routes(a,u,b,f);var w=function(a){return a.preventDefault?a.preventDefault():a.returnValue=!1};var t=function(c){var d,h,n;e=g;var p=n=!1;f.info("RouteSystem: start processing route: '"+g+"'");if("hashchange"===c.type){var r=x;g=window.location.hash;var m=window.location.origin;p=!0;k?history.pushState({href:g},""+g,m+"/"+g):history.replaceState({href:g},""+g,m+"/"+g)}else r=v,m=c.target.href,"popstate"!==c.type&&
k&&history.pushState({href:m},""+m,m),m=window.location.pathname,""===m&&(m="/"),g=m;var q=0;for(d=r.length;q<d;q++){var t=r[q];m=t[0];(h=m.match(g))&&!n&&(n=!0,t=t[1],t.handle_event?t.handle_event(null,m.args):t.apply(null,m.args))}n?(w(c),f.debug("RouteSystem: Url change to: "+g),b.fire(document,"application:urlchange",g,e)):l?(p&&f.warn("Seems you ignore hash based urls: "+g),f.debug("ignore_not_matched_urls is enabled, url was not matched: '"+g+"'")):(f.warn("RouteSystem: route '"+g+"' not found. Generate 404 event"),
b.fire(document,"application:404",g,e),(p=a["404"]||a[404])&&(Sirius.Utils.is_function(p)?u(p)(g):(new Sirius.Internal.ControlFlow(p,u)).handle_event(null,g)),w(c))};d.dispatch=t;0!==v.length&&b.bind(document,d._selector,"click",t);window.onhashchange=t;k&&b.bind(window,null,"popstate",function(a){if(history&&null!=history.state&&void 0!==history.state.href&&0!==history.state.href.indexOf("#"))return t(a)});return c()})}};
...
var lib$sirius$classdecl$var7=function(){return Sirius.Validator.apply(this,arguments)||this};$jscomp.inherits(lib$sirius$classdecl$var7,Sirius.Validator);
...
a&&c.watch_for===b})},find_by_element_watch_for_and_event:function(a,b,c){return this._handlers.filter(function(d){return d.from_element===a&&d.watch_for===b&&d.event===c})}};var lib$sirius$classdecl$var14=function(){};lib$sirius$classdecl$var14.build=function(a){var b=a.from;var c=a.element;return null!=a.state?new Sirius.StateChanges(a.state,b,c):null!=a.attribute?new Sirius.AttributeChanges(a.text,a.attribute,b,c):new Sirius.TextChanges(a.text,b,c)};Sirius.AbstractChangesResult=lib$sirius$classdecl$var14;
var lib$sirius$classdecl$var15=function(a,b,c){Sirius.AbstractChangesResult.call(this);this.text=a;this.from=b;this.target=c};$jscomp.inherits(lib$sirius$classdecl$var15,Sirius.AbstractChangesResult);lib$sirius$classdecl$var15.build=Sirius.AbstractChangesResult.build;Sirius.TextChanges=lib$sirius$classdecl$var15;var lib$sirius$classdecl$var16=function(a,b,c,d){Sirius.AbstractChangesResult.call(this);this.text=a;this.attribute=b;this.from=c;this.target=d};
$jscomp.inherits(lib$sirius$classdecl$var16,Sirius.AbstractChangesResult);lib$sirius$classdecl$var16.build=Sirius.AbstractChangesResult.build;Sirius.AttributeChanges=lib$sirius$classdecl$var16;var lib$sirius$classdecl$var17=function(a,b,c){Sirius.AbstractChangesResult.call(this);this.state=a;this.from=b;this.target=c};$jscomp.inherits(lib$sirius$classdecl$var17,Sirius.AbstractChangesResult);lib$sirius$classdecl$var17.build=Sirius.AbstractChangesResult.build;Sirius.StateChanges=lib$sirius$classdecl$var17;
Sirius.Internal.Observer=function(){var a=function(a,b,c){c=void 0===c?function(){}:c;this._create=this._create.bind(this);this.from_element=a;this.watch_for=b;this.clb=c;Sirius.Application.get_adapter().and_then(this._create)};a.is_text_event=function(a){return-1!==this.TextEvents.indexOf(a.type)};a.is_focus_event=function(a){return-1!==[this.Ev.focusin,this.Ev.focusout].indexOf(a.type)};a.prototype._create=function(a){var f=Sirius.Application.get_logger(this.constructor.name);var h=this.clb;var k=
this.from_element;var l=null;var n=this.watch_for;var r=a.get_attr(k,"tagName");var q=a.get_attr(k,"type");f.debug("Create binding for "+k);var p=Sirius.Internal.Observer;var m=function(b){f.debug("Handler Function: given "+b.type+" event");var c={text:null,attribute:null,from:k,element:b.target};if(!p.is_focus_event(b)){var d=a.text(k);if(-1===[p.Ev.input,p.Ev.selectionchange].indexOf(b.type)||d!==l){p.is_text_event(b)&&(l=c.text=d);b.type===p.Ev.change&&(c.state=a.get_attr(k,"checked"));if("attributes"===
b.type){d=b.attributeName;var e=b.oldValue||[];var g=a.get_attr(k,d);c.text=g;c.attribute=d;c.previous=e}b.type===p.Ev.DOMAttrModified&&(d=b.originalEvent.attrName,e=b.originalEvent.prevValue,g=a.get_attr(k,d),c.text=g,c.attribute=d,c.previous=e);return h(Sirius.AbstractChangesResult.build(c))}}};if(n===Sirius.Internal.DefaultProperty)if(-1!==c.indexOf(r)){f.debug("It is not a "+c);if(-1!==d.indexOf(q)||r===e)return f.debug("Get a "+q+" & "+r+" element for bool elements"),a.bind(document,k,p.Ev.change,
m),Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,n,p.Ev.change,m);l=a.text(k);a.bind(document,k,p.Ev.input,m);Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,n,p.Ev.input,m);if(Sirius.Utils.is_ie9())return f.warn("Hook for work with IE9 browser"),a.bind(document,k,p.Ev.selectionchange,m),Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,n,p.Ev.selectionchange,m)}else return f.warn("Seems you try to bind for "+r+" of "+q+" for 'text' which is not supported");else{if(b){f.debug("MutationObserver support");
var u=new b(function(a){return a.forEach(m)});r={childList:!0,attributes:!0,characterData:!0,attributeOldValue:!0,characterDataOldValue:!0,subtree:!1};q=a.get(k);u.observe(q,r);return Sirius.Internal.CacheObserverHandlers.add_new_observer(k,n,m,u,r)}f.warn("MutationObserver not supported");f.warn("Use Deprecated events for observe");a.bind(document,k,p.Ev.DOMNodeInserted,m);a.bind(document,k,p.Ev.DOMAttrModified,m);Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,n,p.Ev.DOMNodeInserted,
m);return Sirius.Internal.CacheObserverHandlers.add_new_bind_event(k,n,p.Ev.DOMAttrModified,m)}};var b=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver||null;var c=["INPUT","TEXTAREA","SELECT"];var d=["checkbox","radio"];var e="OPTION";a.Ev={input:"input",selectionchange:"selectionchange",childList:"childList",change:"change",DOMNodeInserted:"DOMNodeInserted",focusout:"focusout",focusin:"focusin",DOMAttrModified:"DOMAttrModified"};a.TextEvents=[a.Ev.input,a.Ev.childList,
a.Ev.DOMNodeInserted,a.Ev.selectionchange];return a}.call(this);
...
this.logger.debug("Create a new View for "+this.element);var k=this.constructor._Strategies;a=0;for(b=k.length;a<b;a++){var l=k[a];(function(a){var b=$jscomp.makeIterator(a);a=b.next().value;var e=b.next().value;var f=b.next().value;c.logger.debug("Define '"+a+"' strategy");return c[a]=function(a){a=void 0===a?"text":a;var b=c._result;d=c.element;c.logger.debug("Start processing strategy for the "+d);return Sirius.Application.get_adapter().and_then(function(c){var g="text"===a?c.text(d):c.get_attr(d,
...
if(0===e.length)if(this.logger.info("Bind event for "+a+", event name: "+b+", will be called : "+f),0===l){var r=function(a){return Sirius.Application.get_adapter().and_then(function(b){return b.fire.call.apply(b.fire,[null,document,f,a].concat($jscomp.arrayFromIterable(d)))})};Sirius.Application.get_adapter().and_then(function(c){return c.bind(document,a,b,r)});e=new c(a,b,r);this._cache_event_handlers.push(e)}else Sirius.Application.get_adapter().and_then(function(c){return c.bind(document,a,b,
...
a.prototype.get_attr=function(a){var b=this.get_element();return Sirius.Application.get_adapter().and_then(function(c){return c.get_attr(b,a)})};a.is_valid_strategy=function(a){return 0!==this._Strategies.filter(function(b){return b[0]===a}).length};a.register_strategy=function(a,b){b=void 0===b?{}:b;var c=Sirius.Application.get_logger("Sirius.View.Static");c.info("View: Register new Strategy "+a);var d=b.transform;b=b.render;if(!Sirius.Utils.is_function(d))throw a="Strategy 'transform' must be a function, but "+
typeof d+" given",c.error("View: "+a),Error(a);if(!Sirius.Utils.is_function(b))throw a="Strategy 'render' must be a function, but "+typeof b+" given",c.error("View: "+a),Error(a);if(!Sirius.Utils.is_string(a))throw a="Strategy 'name' must be a string, but "+typeof a+" given",c.error("View: "+a),Error(a);this._Strategies.push([a,d,b]);return null};a._run_view_strategy_registration=function(){Sirius.View.register_strategy("swap",{transform:function(a,b){return""+b},render:function(a,b,c,g){return"text"===
g?a.swap(b,c):"checked"===g?(c=Sirius.Utils.is_string(c)?"true"===c?!0:!1:!!c,a.set_attr(b,"checked",c)):a.set_attr(b,g,c)}});Sirius.View.register_strategy("append",{transform:function(a,b){return b},render:function(a,b,c,g){var d=a.get_attr(b,"tagName");if("INPUT"===d||"TEXTAREA"===d||"SELECT"===d)throw Error("'append' strategy does not work for `input` or `textarea` or `select` elements");if("text"===g)return a.append(b,c);throw Error("Strategy 'append' works only for 'text' content, your call with attribute:'"+
g+"'");}});Sirius.View.register_strategy("prepend",{transform:function(a,b){return b},render:function(a,b,c,g){var d=a.get_attr(b,"tagName");if("INPUT"===d||"TEXTAREA"===d||"SELECT"===d)throw Error("'prepend' strategy does not work for `input` or `textarea` or `select` elements");if("text"===g)return a.prepend(b,c);throw Error("Strategy 'prepend' works only for 'text' content, your call with attribute:'"+g+"'");}});return Sirius.View.register_strategy("clear",{transform:function(a,b){return""},render:function(a,
b,c,g){return a.clear(b)}})};a._Strategies=[];a._Cache=[];var b=function(a,b,c){this.selector=a;this.event_name=b;this.custom_event_name=c};b.prototype.eq=function(a){return this.selector===a.selector&&this.event_name===a.event_name&&this.custom_event_name.toString===a.custom_event_name.toString};var c=b;return a}.call(this);Sirius.View._run_view_strategy_registration();
var lib$sirius$classdecl$var19=function(a,b,c){this.main=a;this.fields=b;this.fn=void 0===c?null:c;this._count=this.fields.length;this._values=[]};lib$sirius$classdecl$var19.prototype.get_fields=function(){return this.fields};lib$sirius$classdecl$var19.prototype.complete=function(a,b){var c={};c[a]=b;return-1===this._values.map(function(a){return Object.keys(a)[0]}).indexOf(a)?(this._values.push(c),this.is_full()?this._result():null):null};lib$sirius$classdecl$var19.prototype.field_name=function(){return this.main};
lib$sirius$classdecl$var19.prototype.remove=function(a){return delete this._values[a]};lib$sirius$classdecl$var19.prototype._result=function(){var a=this._values;var b=this.fields.map(function(b){return a.filter(function(a){return a[b]})[0][b]});return null===this.fn?b.join(" "):this.fn.apply(null,b)};lib$sirius$classdecl$var19.prototype.is_full=function(){return this._values.length===this._count};ComputedField=lib$sirius$classdecl$var19;
Sirius.BaseModel=function(){var a=function(a){a=void 0===a?{}:a;var b,d,e,f,g;(b=this.constructor.prototype)._cmp||(b._cmp=[]);(d=this.constructor.prototype)._cmp_fields||(d._cmp_fields=[]);this._listeners=[];this.logger=Sirius.Application.get_logger(this.constructor.name);this.errors={};this.attributes=this.normalize_attrs();d=this.constructor.name;this.errors={};this._is_valid_attr={};var h=this.attrs();this.binding={};var k=0;for(f=h.length;k<f;k++)if(b=h[k],this.logger.info("define '"+JSON.stringify(b)+
"' attribute for '"+d+"'"),Sirius.Utils.is_object(b)){var l=Object.keys(b);var n=l[0];if(0===l.length)throw this.logger.error("@attrs must be defined as: '@attrs:['id', {'k':'v'}]'"),Error("@attrs must be defined as: '@attrs:['id', {'k':'v'}]'");this["_"+n]=b[n];this._gen_method_name_for_attribute(n)}else this._gen_method_name_for_attribute(b),this["_"+b]=null;var r=this.constructor.skip;d=this.attributes;f=Object.keys(a);l=0;for(h=f.length;l<h;l++)b=f[l],-1===d.indexOf(b)&&r||(this._attribute_present(b),
k=this["_"+b],this["_"+b]=a[b],this._call_callbacks(b,a[b],k));l=this.guid_for();d=0;for(b=l.length;d<b;d++)a=l[d],this.logger.debug("Generate guid for '"+this._klass_name()+"."+a+"'"),this.set(a,this._generate_guid());this._registered_validators=this.constructor._Validators;this._registered_validators_keys=this._registered_validators.map(function(a){return a[0]});this._model_validators=this.validators();this._applicable_validators={};a=this._model_validators;for(n in a)for(g in b=a[n],this.errors[n]=
{},this._is_valid_attr[n]=!1,b){d=b[g];if(-1===this._registered_validators_keys.indexOf(g)&&g!==Sirius.Validator.ValidateWith)throw Error("Unregistered validator: '"+g+"'");if(g===Sirius.Validator.ValidateWith&&!Sirius.Utils.is_function(d))throw Error("Validator for attribute: '"+n+"."+g+"' should be a function, "+typeof d+" given");l=$jscomp.makeIterator(g===Sirius.Validator.ValidateWith?(e=new Sirius.Validator,e.validate=d,e.msg=null,[Sirius.Validator.ValidateWith,e]):(e=this._registered_validators.filter(function(a){return a[0]===
g})[0][1],[g,new e]));d=l.next().value;h=l.next().value;l=this._applicable_validators[n]||{};l[d]=h;this._applicable_validators[n]=l}this._gen_binding_names();this.after_create()};a.comp=function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=this,f,g,h,k;(f=this.prototype)._cmp||(f._cmp=[]);(g=this.prototype)._cmp_fields||(g._cmp_fields=[]);(h=this.prototype)._cmp_refs||(h._cmp_refs={});if(0===b.length)throw Error("Computed fields are empty");if(2===b.length)throw Error('Define compute field like: \'@comp("default_computed_field", "first_name", "last_name")\'');
var l=b[0];d=b.length;f=$jscomp.makeIterator(Sirius.Utils.is_function(b[d-1])?(k=b[d-1],[b.slice(1,d-1),b.slice(1,d-1),k]):[b.slice(1),b.slice(1),null]);b=f.next().value;d=f.next().value;k=f.next().value;f=[l].concat(b);if(f.filter(function(a,b,c){return c.indexOf(a)===b}).length!==f.length)throw Error("Seems your calculated fields are not unique: ["+f+"]");var n=this.attrs.concat(this.prototype._cmp_fields);b.forEach(function(a){if(-1===n.indexOf(a))throw Error("Field '"+a+"' was not found, for '"+
...
if(-1!==Object.keys(this).indexOf(d))throw Error("Method '"+d+"' already exist");return this[d]=function(c){return null!=c?b.set(a,c):b.get(a)}};a.prototype._gen_binding_names=function(){var a,c,d;var e={};var f=this.get_attributes();var g=0;for(c=f.length;g<c;g++){var h=f[g];if(h===Sirius.Internal.Errors)throw Error("'errors' name is reserved");e[h]=h}if(0!==Object.keys(this._applicable_validators).length){h={};g=this._applicable_validators;for(a in g){f=g[a];c={};var k=Object.keys(f);f=0;for(d=
k.length;f<d;f++){var l=k[f];if("all"===l)throw Error("Name 'all' for validators is reserved");c[l]=Sirius.Internal.Errors+"."+a+"."+l}c.all=Sirius.Internal.Errors+"."+a+".all";h[a]=c}h.all=Sirius.Internal.Errors+".all";e[Sirius.Internal.Errors]=h}return this.binding=e};a.prototype.get_binding=function(){return this.binding};a.prototype._generate_guid=function(){var a=function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)};return""+a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+
a()+a()};a.prototype.get_attributes=function(){return this.attributes};a.prototype._is_computed_attribute=function(a){return-1!==this.constructor.prototype._cmp_fields.indexOf(a)?!0:!1};a.prototype._attribute_present=function(a){if(-1===this.attributes.indexOf(a))throw Error("Attribute '"+a+"' not found for "+this._klass_name()+" model");};a.prototype._call_callbacks=function(a,c,d){var b;var f=this._listeners;var g=0;for(b=f.length;g<b;g++){var h=f[g];h.apply(null,[a,c])}return this.after_update(a,
c,d)};a.prototype._call_callbacks_for_errors=function(a,c,d){var b;a=Sirius.Internal.Errors+"."+a+"."+c;var f=this._listeners;var g=[];var h=0;for(b=f.length;h<b;h++)c=f[h],g.push(c.apply(null,[a,d]));return g};a.prototype.set=function(a,c){if(this._is_computed_attribute(a))throw Error("Impossible set computed attribute '"+a+"' in '"+this._klass_name()+"'");return this._set(a,c)};a.prototype._set=function(a,c,d){d=void 0===d?!1:d;this._attribute_present(a);var b=this["_"+a];this["_"+a]=c;this.validate(a);
return d||this.is_valid(a)?(this.logger.debug("["+this.constructor.name+"] set: '"+c+"' to '"+a+"'"),this._compute(a,c),this._call_callbacks(a,c,b)):this["_"+a]=b};a.prototype.get=function(a){this._attribute_present(a);return this["_"+a]};a.prototype.reset=function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e;var f=null!=b&&0!==b.length?b:this.attrs();this.logger.debug("Reset attributes: '"+f.join(",")+"' for "+this._klass_name());d=0;for(e=f.length;d<e;d++)b=f[d],this._set(b,
null,!0),null!=this.errors[b]&&(this.errors[b]={})};a.prototype._is_valid_validator=function(a){a=a.split(".");if(2===a.length){var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;return null!=this._applicable_validators[a]&&null!=this._applicable_validators[a][b]}return!1};a.prototype.is_valid=function(a){var b=this;a=void 0===a?null:a;return null!=a?null!=this._is_valid_attr[a]?this._is_valid_attr[a]:!0:0===Object.keys(this._is_valid_attr).filter(function(a){return!b._is_valid_attr[a]}).length};
a.prototype.validate=function(a){a=void 0===a?null:a;var b,d;var e=this._klass_name();var f=this.logger;var g=Object.keys(this._model_validators||{});var h=null!=a?g.filter(function(b){return b===a}):g;var k=0;for(b=h.length;k<b;k++){var l=h[k];var n=this.get(l);g=this._model_validators[l];for(d in g){var r=g[d];var q=this._applicable_validators[l][d];r=q.validate(n,r);f.debug("Validate: '"+e+"."+l+" = "+n+"' with '"+d+"' validator, valid?: '"+r+"'");q=r?(delete this.errors[l][d],this._is_valid_attr[l]=
!0,""):(this.errors[l][d]=q.error_message(),this._is_valid_attr[l]=!1,q.error_message());this._call_callbacks_for_errors(l,d,q)}}};a.prototype.get_errors=function(a){a=void 0===a?null:a;var b;if(null!=a){this._attribute_present(a);var d=[];a=this.errors[a];for(b in a){var e=a[b];""!==e&&d.push(e)}return d}return this.errors};a.prototype.set_error=function(a,c){a=a.split(".");if(2!==a.length)throw Error("Message must be pass as 'attr.validator' like 'name.length'");var b=$jscomp.makeIterator(a);a=
...
};a.prototype.after_create=function(){};a.prototype.after_update=function(a,c,d){};a.prototype.clone=function(){return this.constructor.from_json(this.to_json())};a.prototype._register_state_listener=function(a){var b;this.logger.debug("Register new listener for "+this.constructor.name);this._listeners.push(a);var d=this.get_attributes();var e=[];var f=0;for(b=d.length;f<b;f++){var g=d[f];null!==this["_"+g]?e.push(a.apply(null,[g,this["_"+g]])):e.push(void 0)}return e};a.register_validator=function(a,
c){Sirius.Application.get_logger("Sirius.BaseModel.Static").info("register validator: "+a);this._Validators.push([a,c]);return null};a._run_base_model_validator_registration=function(){Sirius.BaseModel.register_validator("length",Sirius.LengthValidator);Sirius.BaseModel.register_validator("exclusion",Sirius.ExclusionValidator);Sirius.BaseModel.register_validator("inclusion",Sirius.InclusionValidator);Sirius.BaseModel.register_validator("format",Sirius.FormatValidator);Sirius.BaseModel.register_validator("numericality",
Sirius.NumericalityValidator);return Sirius.BaseModel.register_validator("presence",Sirius.PresenceValidator)};a._Validators=[];a.attrs=[];a.skip=!1;a.guid_for=null;a.validate={};a.prototype.__name="BaseModel";return a}.call(this);Sirius.BaseModel._run_base_model_validator_registration();
...
lib$sirius$classdecl$var21.prototype.to_string=function(){return this.dump()};lib$sirius$classdecl$var21.prototype.get_from=function(){return this._from};lib$sirius$classdecl$var21.prototype.get_to=function(){return this._to()};lib$sirius$classdecl$var21.prototype.has_to=function(){return null!=this._to};lib$sirius$classdecl$var21.prototype.fields_map=function(){var a;var b={};var c=this.fields;var d=0;for(a=c.length;d<a;d++){var e=c[d];b[e.field()]=e}return b};
lib$sirius$classdecl$var21.prototype.run=function(){throw Error("Not Implemented");};Sirius.AbstractMaterializer=lib$sirius$classdecl$var21;var lib$sirius$classdecl$var22=function(){Sirius.AbstractMaterializer.apply(this,arguments)};$jscomp.inherits(lib$sirius$classdecl$var22,Sirius.AbstractMaterializer);
lib$sirius$classdecl$var22.prototype.transform=function(a){if(!Sirius.Utils.is_function(a))throw Error("'transform' attribute must be function, "+typeof a+" given");if(null==this.current)throw Error("Incorrect call. Call 'transform' after 'to' or 'attribute'");if(!this.current.has_to())throw Error("Incorrect call. Call 'to' before 'transform'");if(this.current.has_transform())throw Error("Incorrect call. The field already has 'transform' function");this.current.transform(a);return this};
Sirius.MaterializerTransformImpl=lib$sirius$classdecl$var22;var lib$sirius$classdecl$var23=function(){Sirius.MaterializerTransformImpl.apply(this,arguments)};$jscomp.inherits(lib$sirius$classdecl$var23,Sirius.MaterializerTransformImpl);lib$sirius$classdecl$var23.prototype.field=function(a){var b=a;Sirius.Utils.is_function(a)&&(b=a(this._from.get_binding()));Sirius.Materializer._check_model_compliance(this._from,b);Sirius.MaterializerTransformImpl.prototype.field.call(this,b);return this};
lib$sirius$classdecl$var23.prototype.to=function(a){if(null==this.current)throw Error("Incorrect call. Call 'to' after 'field'");if(!(Sirius.Utils.is_function(a)||Sirius.Utils.is_string(a)||a instanceof Sirius.View))throw Error("'to' must be string or function, or instance of Sirius.View");var b=a;Sirius.Utils.is_string(a)&&(b=this._zoom_with(this._to,a));Sirius.Utils.is_function(a)&&(b=this._zoom_with(this._to,a(this._to)));if(this.current.has_to())throw Error("Incorrect call. '"+this.current.field()+
"' already has 'to'");this.current.to(b);return this};lib$sirius$classdecl$var23.prototype.attribute=function(a){if(null==this.current)throw Error("Incorrect call. Define 'field' firstly, and then call 'attribute' after 'to'");if(!this.current.has_to())throw Error("Incorrect call. Call 'to' before 'attribute'");if(this.current.has_attribute())throw Error("Incorrect call. '"+this.current.field()+"' already has 'attribute'");this.current.attribute(a);return this};
lib$sirius$classdecl$var23.prototype.to_attribute=function(a){return this.attribute(a)};lib$sirius$classdecl$var23.prototype.handle=function(a){if(null==this.current)throw Error("Incorrect call. 'field' is not defined");if(!this.current.has_to())throw Error("Incorrect call. define 'to'");if(!Sirius.Utils.is_function(a))throw Error("'handle' must be a function");if(this.current.has_handle())throw Error("'handle' already defined");this.current.handle(a);return this};
lib$sirius$classdecl$var23.prototype.run=function(){this.current.normalize();var a=this.fields_map();return this._from._register_state_listener(function(b,c){var d;b=Sirius.Materializer.get_necessary_functions(a,b);var e=[];var f=0;for(d=b.length;f<d;f++){var g=b[f];var h=g.transform().call(null,c,g.to());g.has_handle()?e.push(g.handle().call(null,g.to(),h)):e.push(g.to().render(h).swap(g.attribute()))}return e})};Sirius.ModelToViewMaterializer=lib$sirius$classdecl$var23;
var lib$sirius$classdecl$var24=function(){Sirius.MaterializerTransformImpl.apply(this,arguments)};$jscomp.inherits(lib$sirius$classdecl$var24,Sirius.MaterializerTransformImpl);
lib$sirius$classdecl$var24.prototype.field=function(a){if(Sirius.Utils.is_string(a))a=this._from.zoom(a);else if(Sirius.Utils.is_function(a))a=this._zoom_with(this._from,a(this._from));else if(!(a instanceof Sirius.View))throw Error("Element must be string or function, or instance of Sirius.View");Sirius.MaterializerTransformImpl.prototype.field.call(this,a);return this};
lib$sirius$classdecl$var24.prototype.from=function(a){if(null==this.current)throw Error("Incorrect call. Define 'field' firstly, and then call 'from'");if(this.current.has_to())throw Error("Incorrect call. Call 'from' before 'to'");if(this.current.has_attribute())throw Error("Incorrect call. '"+this.current.field().get_element()+"' already has 'from'");this.current.attribute(a);return this};lib$sirius$classdecl$var24.prototype.from_attribute=function(a){return this.from(a)};
lib$sirius$classdecl$var24.prototype.to=function(a){if(null==this.current)throw Error("Incorrect call. Define 'field' firstly, and then call 'from'");if(this.current.has_to())throw Error("Incorrect call. '"+this.current.field().get_element()+"' already has 'to'");var b=a;null!=this._to&&Sirius.Utils.is_function(a)&&(b=a(this._to.get_binding()));null!=this._to&&this._to instanceof Sirius.BaseModel&&Sirius.Materializer._check_model_compliance(this._to,b);this.current.to(b);return this};
lib$sirius$classdecl$var24.prototype.run=function(){var a;this.current.normalize();var b=this._to;var c=function(a){return function(c){c=a.transform().call(null,c);return-1!==a.to().indexOf(".")?b.set_error(a.to(),c):b.set(a.to(),c)}};var d=this.fields;var e=[];var f=0;for(a=d.length;f<a;f++){var g=d[f];var h=c(g);h=new Sirius.Internal.Observer(g.field().get_element(),g.attribute(),h);e.push(g.field()._register_state_listener(h))}return e};Sirius.ViewToModelMaterializer=lib$sirius$classdecl$var24;
var lib$sirius$classdecl$var25=function(){Sirius.ViewToModelMaterializer.apply(this,arguments)};$jscomp.inherits(lib$sirius$classdecl$var25,Sirius.ViewToModelMaterializer);
lib$sirius$classdecl$var25.prototype.to=function(a){if(Sirius.Utils.is_string(a))a=this._to.zoom(a);else if(!(a instanceof Sirius.View))if(Sirius.Utils.is_function(a))a=this._zoom_with(this._to,a(this._to));else throw Error("Element must be string or function, or instance of Sirius.View");Sirius.ViewToModelMaterializer.prototype.to.call(this,a);return this};
lib$sirius$classdecl$var25.prototype.handle=function(a){if(null==this.current)throw Error("Incorrect call. 'field' is not defined");if(!this.current.has_to())throw Error("Incorrect call. define 'to'");if(!Sirius.Utils.is_function(a))throw Error("'handle' must be a function");if(this.current.has_handle())throw Error("'handle' already defined");this.current.handle(a);return this};
lib$sirius$classdecl$var25.prototype.run=function(){var a;this.current.normalize();var b=function(a){return function(b){b=a.transform().call(null,b);return a.has_handle()?a.handle().call(null,a.to(),b):a.to().render(b).swap()}};var c=this.fields;var d=[];var e=0;for(a=c.length;e<a;e++){var f=c[e];var g=new Sirius.Internal.Observer(f.field().get_element(),f.attribute(),b(f));d.push(f.field()._register_state_listener(g))}return d};Sirius.ViewToViewMaterializer=lib$sirius$classdecl$var25;
var lib$sirius$classdecl$var26=function(){Sirius.ViewToModelMaterializer.apply(this,arguments)};$jscomp.inherits(lib$sirius$classdecl$var26,Sirius.ViewToModelMaterializer);lib$sirius$classdecl$var26.prototype.to=function(a){if(!Sirius.Utils.is_function(a))throw Error("Function is required");Sirius.ViewToModelMaterializer.prototype.to.call(this,a);return this};
lib$sirius$classdecl$var26.prototype.run=function(){var a;this.current.normalize();var b=this.fields;var c=[];var d=0;for(a=b.length;d<a;d++){var e=b[d];var f=new Sirius.Internal.Observer(e.field().get_element(),e.attribute(),e.to());c.push(e.field()._register_state_listener(f))}return c};Sirius.ViewToFunctionMaterializer=lib$sirius$classdecl$var26;var lib$sirius$classdecl$var27=function(){Sirius.AbstractMaterializer.apply(this,arguments)};$jscomp.inherits(lib$sirius$classdecl$var27,Sirius.AbstractMaterializer);
lib$sirius$classdecl$var27.prototype.field=function(a){var b=a;Sirius.Utils.is_function(a)&&(b=a(this._from.get_binding()));Sirius.Materializer._check_model_compliance(this._from,b);Sirius.AbstractMaterializer.prototype.field.call(this,b);return this};
lib$sirius$classdecl$var27.prototype.to=function(a){if(null==this.current)throw Error("Incorrect call. Define 'field' firstly");if(this.current.has_to())throw Error("Incorrect call. The field already has 'to'");if(!Sirius.Utils.is_function(a))throw Error("Function is required");this.current.to(a);return this};
lib$sirius$classdecl$var27.prototype.run=function(){var a=this.fields_map();return this._from._register_state_listener(function(b,c){var d;b=Sirius.Materializer.get_necessary_functions(a,b);var e=[];var f=0;for(d=b.length;f<d;f++){var g=b[f];e.push(g.to().call(null,c))}return e})};Sirius.ModelToFunctionMaterializer=lib$sirius$classdecl$var27;
